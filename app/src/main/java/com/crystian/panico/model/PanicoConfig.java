...
public class PanicoConfig extends SugarRecord<PanicoConfig> {
        ...
        public PanicoConfig(String telefone1, Boolean telefone1_ligar, Boolean telefone1_sms, String telefone2, Boolean telefone2_ligar, Boolean telefone2_sms, String telefone3, Boolean telefone3_ligar, Boolean telefone3_sms) {
